  ...
  const infiltrationGames = [
    ...
    },
    {
      ...
      play: function (screen) {
        ...
        const compareString1 = "ATTACKING!"
        const compareString2 = "Prexparing?"
  
        wnd.lastSlashInfo = { data }
        if ('wait' === state.game.data && (data.indexOf(compareString1) + data.indexOf(compareString2) > -2)) {
          console.log('data is ' + data + ' -> pressing space')
          pressKey(32)
